...
usar return
--------------------------------------------------------
VANTAGENS DA MODLARIZAÇÃO
1. FACILITA MANUTENÇÃO
2. FACILITA O DESENVOLVIMENTO EM EQUIPE
3. REUTILIZAÇÃO DE CÓDIGO
4. ORGANIZAÇÃO
 * dividir para conquistar
--------------------------------------------------------
    API - APLICATION PROGRAMING INTERFACE
CONJUNTO DE ROTINAS E PADRÕES DE PROGRAMAÇÃO PARA ACESSO A UMA APLICAÇÃO

BASICAMENTE VOCÊ USA UMA API PRA USAR OS MÓDULOS DE UM SERVIDOR EXTERNO

RETORNA TUDO EM JSON
    JSON - JAVASCRIPT OBJECT NOTATION

UMA API É CRIADA QUANDO UMA EMPRESA TEM INTERESSE QUE OUTROS DESENVOLVEDORES DESENVOLVAM COM SEU PRODUTO
---------------------------------------------------------
*/