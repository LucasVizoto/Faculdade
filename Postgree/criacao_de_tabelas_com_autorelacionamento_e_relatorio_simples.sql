...
--elaborar um relatorio para exibir o nome do empregados juntamente com o nomedo seu respectivo gerente

SELECT e.nome || ' trabalha para ' || g.nome "Quem é gerente de quem??"
FROM tb_empregados e
INNER JOIN tb_empregados g ON(e.rg_gerente = g.rg_empregados)
ORDER BY e.nome;